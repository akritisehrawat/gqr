...
import Header from '../../containers/support/HeaderContainer.js';
...
var bgimages = ['images/backgrounds/Blur.jpg','images/backgrounds/Canary-wharf.jpg'];
...
if (!jQuery.browser.mobile ) {
        ...
        $('#backgroundCycle div.img').eq(0).addclassName('active').fadeTo(1500,1)
        setInterval(function(){
            if (!$('#backgroundCycle div.img.active').next('div.img').length) {
                $('#backgroundCycle div.img.active').fadeTo(1500, 0).removeclassName('active');
                $('#backgroundCycle div.img').eq(0).addclassName('active').fadeTo(3000,1)
            } else {
                $('#backgroundCycle div.img.active').fadeTo(1500, 0).removeclassName('active').next('div.img').addclassName('active').fadeTo(3000,1);
            }
        },6000);
        }
    }
